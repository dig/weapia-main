...
public class Constants {
    ...
    public static final String DEFAULT_PING_TOP_LINE = "&a&lMinevasion &8➤ &6&lPlay Soon! &81.8-1.14";
    ...
    public static final String PROXY_RESTART = ChatColor.RED + "This proxy is restarting in 30 seconds, please connect back to: play.minevasion.com.";

    public static final List<String> PLAYER_WELCOME_MESSAGE = Arrays.asList(
            " ",
            StringUtil.center(ChatColor.GREEN + "" + ChatColor.BOLD + "Minevasion", 154),
            " ",
    ...
    public static final String PARTY_KICK = ChatColor.LIGHT_PURPLE + "\u2996 %s has been kicked from the party.";
